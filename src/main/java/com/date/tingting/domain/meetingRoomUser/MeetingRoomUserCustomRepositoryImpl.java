...
@Slf4j
@Service
public class MeetingRoomUserCustomRepositoryImpl implements MeetingRoomUserCustomRepository {

    JPAQueryFactory jpaQueryFactory;

    public MeetingRoomUserCustomRepositoryImpl(EntityManager em) {
